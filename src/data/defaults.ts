/**
 * Hardcoded fallback values used when the database returns empty or partial data.
 * Every field displayed on the homepage has a guaranteed default here.
 */

export const SITE_URL = 'https://sheikhshariarnehal.me';
